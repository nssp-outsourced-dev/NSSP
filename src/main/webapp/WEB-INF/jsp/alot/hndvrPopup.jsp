...
var myGridID;
	...
	function initGrid() {
		var columnLayout = [
			...
			{ dataField : "DEPT_NM", headerText : "소속", width : 200},
			{ dataField : "USER_NM", headerText : "성명", width : 100},
			{ dataField : "RSPOFC_NM", headerText : "직책", width : 100},
			{ dataField : "CLSF_NM", headerText : "직급", width : 0},
			{ dataField : "ALOT_CNT", headerText : "배당건수(진행중)", width : 150}
		];
...
<input type="hidden" id="hidUserId" name="hidUserId" value="${chargerId}">
...
<input type="hidden" id="chkAlotJobSe" name="chkAlotJobSe" value="H">
		...
		<div class="tb_01_box">
			<table  class="tb_01">
				...
				<tr>
					...
					<td>
						<div class="flex_r">
							<input type="text" id="txtDeptNm" name="txtDeptNm" class="w_250px input_com" check="text" checkName="부서" readonly <c:if test="${mngr_yn eq 'Y'}">onfocus="fnDeptSelect();this.blur();"</c:if> value="${deptNm}">	
