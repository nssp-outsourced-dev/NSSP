	...
	<form id="frmList" name="frmList" action="<c:url value='/member/update/'/>">
		...
		<table width="1000px" class="board" summary="" cellpadding="0" cellspacing="0" >
			...
			<tr class="border_bottom_b">
				<th>진행상태</th>
				<td >
					전체	<input type="radio"	name="radioProgressStatus">
					미처리	<input type="radio"	name="radioProgressStatus">
					처리	<input type="radio"	name="radioProgressStatus">
					반려	<input type="radio"	name="radioProgressStatus">
				</td>
				<th>페이지건수</th>
				<td><!-- 그리드 paging 관련 -->
