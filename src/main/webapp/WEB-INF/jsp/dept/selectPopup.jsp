		...
		var iUrl = '<c:url value='/dept/deptFullListAjax/'/>';
 		...
 		var processAfterGet = function(data) {
			...
			for(var i = 0; i < data.length; i++){
				sRow = data[i];
				sNode = "<a href=\"javascript:fnSelect('"+ sRow.DEPT_CD +"','"+ sRow.DEPT_NM +"');\" title=\""+ sRow.DEPT_NM +"\">"+ sRow.DEPT_NM +"</a>";
...
<input type="hidden" id="txtDeptUpperCd" name="txtDeptUpperCd" value="${upper_cd}">
