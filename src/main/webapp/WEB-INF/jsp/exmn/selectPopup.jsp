		...
		var iUrl = '<c:url value='/exmn/exmnFullListAjax/'/>';
 		...
 		var processAfterGet = function(data) {
			...
			for(var i = 0; i < data.length; i++){
				sRow = data[i];
				sNode = "<a href=\"javascript:fnSelect('"+ sRow.EXMN_CD +"','"+ sRow.EXMN_NM +"');\" title=\""+ sRow.EXMN_NM +"\">"+ sRow.EXMN_NM +"</a>";
...
<input type="hidden" id="txtExmnUpperCd" name="txtExmnUpperCd" value="${upper_cd}">
