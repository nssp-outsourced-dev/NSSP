...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/member/authorizationLogAjax/", "frmList", "#grid_list", 1);
	}

	function initGrid() {
		var columnLayout = [
			{ dataField : "RN", headerText : "순번", width : 30},
			{ dataField : "AUTHOR_DT", headerText : "일시", width : 80},
			{ dataField : "AUTHOR_NM", headerText : "권한부여자", width : 50},
			{ dataField : "AUTHOR_IP", headerText : "부여자IP", width : 100},
			{ dataField : "AUTHOR_TRGTER_NM", headerText : "부여대상", width : 50},
			{ dataField : "AUTHOR_JOB_NM", headerText : "처리작업", width : 50},
			{ dataField : "AUTHOR_JOB", headerText : "변경내역", width : 100,
				/*  */
				labelFunction : function( rowIndex, columnIndex, value, headerText, item ){
					if(value == "U"){
						return item.PREV_AUTHOR_NM + " > " + item.NOW_AUTHOR_NM;
					}else if(value == "C"){
						return " > " + item.NOW_AUTHOR_NM;
					}else{
						return "";
					}
				},
			},
			//{ dataField : "MENUS", headerText : "메뉴명", width : 200}
		];
