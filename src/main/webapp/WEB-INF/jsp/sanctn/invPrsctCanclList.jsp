...
<script type="text/javascript">
	...
	function initGrid() {
		var columnLayout = [{
				...
				headerText : "사건번호", dataField : "CASE_NO", width : 80
			}, {
				headerText : "입건일자", dataField : "PRSCT_DE", width : 90, dataType : "date", formatString : "yyyy-mm-dd hh:MM"
			}, {
				headerText : "접수구분", dataField : "RC_SE_NM", width : 50
			}, {
				headerText : "수사단서", dataField : "INV_PROVIS_NM", width : 50
			}, {
				headerText : "대상자명", dataField : "TRGTER_NMS", width : 70
			}, {
				headerText : "위반사항", dataField : "VIOLT_NMS", width : 200
			}, {
				headerText : "담당자", dataField : "CHARGER_NM", width : 60
			}, {
				headerText : "입건취소사유", dataField : "CANCL_RESN_NM", width : 80
			}, {
				headerText : "취소내용", dataField : "CANCL_CN", width : 100				
			}, {				
				headerText : "진행상태", dataField : "PROGRS_STTUS_NM", width : 110
			}, {
				headerText : "요청자", dataField : "REQ_NM", width : 60
			}, {
				headerText : "요청일시", dataField : "REQ_DT", width : 90, dataType : "date", formatString : "yyyy-mm-dd hh:MM"
			}, {
				...
				labelFunction : function (rowIndex, columnIndex, value, headerText, item ) {
					var template = "<a href=\"javascript:void(0);\" onClick=\"fnDocListPopup('D', '"+item.SANCTN_ID+"');\" class=\"btn_td2 icon_n fl \">요청상세</a>";
					return template;
				}
			}, {
				headerText : "승인(변려)자", dataField : "CONFMER_NM", width : 70
			}, {
				headerText : "승인(반려)일시", dataField : "CONFM_DT", width : 90, dataType : "date", formatString : "yyyy-mm-dd hh:MM"
			}, {
	...
	function fnSearch() {
		...
		fnMoveGridPage("/sanctn/invPrsctCanclListAjax/", "frmList", "#grid_list", 1);
	}

	function fnConfm(sttusCd){
		fnConfmSanctn("D", sttusCd);
	}
