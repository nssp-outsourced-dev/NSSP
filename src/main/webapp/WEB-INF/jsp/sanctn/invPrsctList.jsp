...
<script type="text/javascript">
	...
	function initGrid() {
		var columnLayout = [{
				...
				labelFunction : function (rowIndex, columnIndex, value, headerText, item ) {
					var template = "<a href=\"javascript:void(0);\" onClick=\"fnDocListPopup('C', '"+item.SANCTN_ID+"');\" class=\"btn_td2 icon_n fl \">요청상세</a>";
					return template;
				}
			}, {
	...
	function fnSearch() {
		...
		fnMoveGridPage("/sanctn/invPrsctListAjax/", "frmList", "#grid_list", 1);
	}

	function fnConfm(sttusCd){
		fnConfmSanctn("C", sttusCd);
	}
