...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/stats/caseManageListAjax/", "frmList", "#grid_list", 1);
	}
	...
	function initGrid() {
		var columnLayout = [
			...
			*/
			...
			{ dataField : "PROGRS_STTUS_NM", headerText : "진행상태", width : 100},
			{ dataField : "INV_PROVIS_NM", headerText : "수사단서", width : 100},
			{ dataField : "SUSPCT_NM", headerText : "피의자", width : 150},
			{ dataField : "VIOLT_NM", headerText : "위반죄명", width : 200},
			{ dataField : "CHARGER_NM", headerText : "담당자", width : 100},
			{ dataField : "SUFRER_NM", headerText : "피해자", width : 150},
			{ dataField : "PRSCT_DE", headerText : "입건일자", width : 100},
			{ dataField : "TRN_DE", headerText : "송치일자", width : 100}
		];
