...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/stats/cmprListAjax/", "frmList", "#grid_list", 1);
	}
	...
	function initGrid() {
		var columnLayout = [
			...
			{ dataField : "VIOLT_ROOT_NM", 		headerText : "죄명", width : 200, cellMerge : true, mergePolicy:"restrict", mergeRef: "CASE_NO",},
			...
			{ dataField : "", headerText : "검사", width : 120 },
			{ dataField : "", headerText : "신청관서", width : 120 },
			{ dataField : "", headerText : "처분을 금지하는 재산ㆍ권리", width : 200 },
			{ dataField : "", headerText : "몰수보전사건의 표시", width : 200 },
			{ headerText : "특별사법 경찰관 신청",
				children: [
					{ dataField : "REQST_DE", headerText : "신청일", width : 120, cellMerge : true, mergePolicy:"restrict", mergeRef: "CASE_NO", },
					{ dataField : "REQST_DE", headerText : "기각일", width : 120 },
				]
			},
			{ headerText : "검사 청구",
				children: [
					{ dataField : "REQST_DE", headerText : "청구일", width : 120, cellMerge : true, mergePolicy:"restrict", mergeRef: "CASE_NO", },
					{ dataField : "REQST_DE", headerText : "기각일", width : 120 },
					{ dataField : "", headerText : "요지", width : 120 },
				]
			},
			{ headerText : "특별사법 경찰관 재신청",
				children: [
					{ dataField : "REQST_DE", headerText : "청구일", width : 120, cellMerge : true, mergePolicy:"restrict", mergeRef: "CASE_NO", },
					{ dataField : "REQST_DE", headerText : "기각일", width : 120 },
					{ dataField : "", headerText : "요지", width : 120 },
			...
			{ dataField : "REQST_DE", headerText : "결정문수령일", width : 120 },
			{ dataField : "REQST_NM", headerText : "수령자의 직급ㆍ성명ㆍ날인", width : 200 },
			{ headerText : "항고",
				children: [
					{ dataField : "REQST_DE", headerText : "제기일", width : 120, cellMerge : true, mergePolicy:"restrict", mergeRef: "CASE_NO", },
					{ dataField : "REQST_DE", headerText : "결정일", width : 120 },
					{ dataField : "", headerText : "요지", width : 120 },
				]
			},
			{ headerText : "재항고",
			...
			{ dataField : "REQST_DE", headerText : "종국연월일", width : 120 },
			{ dataField : "CASE_NO", headerText : "몰수ㆍ부대보전부 번호", width : 200 },
			{ dataField : "", headerText : "비고", width : 120 },
		];
	...
	function fnExportTo() {
		...
		if(rowCount >= 100000) {
			...
			AUIGrid.exportToCsv(myGridID, {
				fileName : "몰수 부대보전 신청부_CSV"
			});
		}else{
			AUIGrid.exportToXlsx(myGridID, {
				fileName : "몰수 부대보전 신청부_EXCEL"
			});
		}
	};
