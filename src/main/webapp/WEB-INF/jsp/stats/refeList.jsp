...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/invsts/refeListAjax/", "frmList", "#grid_list", 1);
	}

	function initGrid() {
		var columnLayout = [
			{ dataField : "grdRn", 				headerText : "순번", 		width : 50, cellMerge : true, style:'grdChkDt',
			...
			{ dataField : "grdTrgterNm", 		headerText : "참고인 등", cellMerge : true, mergeRef : "grdMgNo", mergePolicy : "restrict",
				styleFunction :  function(rowIndex, columnIndex, value, headerText, item, dataField) {
					if(item.grdChkDt == "F") {
						return "clsRed";
					}
			...
			{ dataField : "grdTrnDe", 			headerText : "송치일자", 	width : 100, dataType : "date", formatString : "yyyy-mm-dd", cellMerge : true, mergeRef : "grdMgNo", mergePolicy : "restrict",
				styleFunction :  function(rowIndex, columnIndex, value, headerText, item, dataField) {
					if(item.grdChkDt == "F") {
						return "clsRed";
					}
