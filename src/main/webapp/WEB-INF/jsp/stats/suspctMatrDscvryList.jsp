...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/stats/suspctMatrDscvryListAjax/", "frmList", "#grid_list", 1);
	}
	...
	function initGrid() {
		var columnLayout = [
			...
			{ dataField : "TRGTER_NM", headerText : "피의자 또는 참고인", width : 120 },
			{ dataField : "DSCVRY_DE", headerText : "소재발견일자", width : 120, dataType : "date", formatString : "yyyy-mm-dd" },
			{ dataField : "DSCVRY_RESN", headerText : "소재발견사유<br>(검거, 재기신청)", width : 120 },
			{ dataField : "DSCVRY_REPORT_DE", headerText : "소재발견 보고일", width : 120, dataType : "date", formatString : "yyyy-mm-dd" },
			{ dataField : "VIOLT_NM", headerText : "죄명", width : 200 },
			{ dataField : "SRCCRM_RELIS_DE", headerText : "수배해제일자", width : 120, dataType : "date", formatString : "yyyy-mm-dd" },
			{ dataField : "CASE_NO", headerText : "재기 전 사건번호", width : 120,
			...
			{ dataField : "TRN_DE", headerText : "송치일<br>(송치의견)", width : 120, dataType : "date", formatString : "yyyy-mm-dd" },
			{ dataField : "CHARGER_NM", headerText : "담당자", width : 100 },
			{ dataField : "TEMP", headerText : "비고", width : 50 },
		];
	...
	function fnExportTo() {
		...
		if(rowCount >= 100000) {
			...
			AUIGrid.exportToCsv(myGridID, {
				fileName : "피의자 등 소재발견처리부_CSV"
			});
		}else{
			AUIGrid.exportToXlsx(myGridID, {
				fileName : "피의자 등 소재발견처리부_EXCEL"
			});
		}
	};
</script>
