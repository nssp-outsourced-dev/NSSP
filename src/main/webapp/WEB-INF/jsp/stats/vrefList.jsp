...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/stats/vrefListAjax/", "frmList", "#grid_list", 1);
	}
	...
	function initGrid() {
		var columnLayout = [
			...
			{ headerText : "통신사실 확인 자료제공 요청",
				children: [
					{ dataField : "PRMISN_PROGRS_NO", 		headerText : "허가서 번호", width : 50, cellMerge : true, mergePolicy:"restrict", mergeRef: "REQST_DE"},
					{ dataField : "TRGTER_NM", headerText : "통지 대상자", width : 120 },
				]
			},
			{ headerText : "통신사실 확인자료제공 요청 집행사건",
				children: [
					{ dataField : "CHARGER_NM", headerText : "집행자의 직급 및 성명", width : 120 },
					{ dataField : "CASE_NO", headerText : "사건번호", width : 120 },
					{ dataField : "REQST_RESULT_NM", headerText : "처리일자 및 처리결과", width : 120 },
					{ dataField : "ISUE_DE", headerText : "처리결과를 통보받은 일자", width : 120 },
				]
			},
	...
	function fnExportTo() {
		...
		if(rowCount >= 100000) {
			...
			AUIGrid.exportToCsv(myGridID, {
				fileName : "통신사실 확인자료제공 요청 집행사실 통지부_CSV"
			});
		}else{
			AUIGrid.exportToXlsx(myGridID, {
				fileName : "통신사실 확인자료제공 요청 집행사실 통지부_EXCEL"
			});
		}
	};
