...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/stats/vrpcListAjax/", "frmList", "#grid_list", 1);
	}

	function initGrid() {
		var columnLayout = [
			{ dataField : "RC_NO", visible : false},
			{ dataField : "RN", 		headerText : "순번", width : 50, cellMerge : true, mergePolicy:"restrict", mergeRef: "REQST_DE"},
			{ dataField : "REQST_DE", headerText : "신청일자", width : 120, dataType : "date", formatString : "yyyy-mm-dd" },
			{ headerText : "통신사실 확인 자료제공 요청",
				children: [
					{ dataField : "PRMISN_PROGRS_NO", 		headerText : "허가서 번호", width : 100, cellMerge : true, mergePolicy:"restrict", mergeRef: "REQST_DE"},
					{ dataField : "TRGTER_NM", headerText : "대상자", width : 120 },
				]
			},
			{ headerText : "통신사실 확인 자료제공 요청",
				children: [
					{ dataField : "CASE_NO", headerText : "사건번호", width : 120 },
					{ dataField : "REQST_RESULT_NM", headerText : "처리일자 및 처리결과", width : 120 },
					{ dataField : "ISUE_DE", headerText : "통보받은 일자", width : 120 },
				]
			},
			{ dataField : "EXCUT_DT", headerText : "통지일자", width : 120, dataType : "date", formatString : "yyyy-mm-dd" },
			{ dataField : "", headerText : "유예사유 해소 후 통지일자", width : 120, dataType : "date", formatString : "yyyy-mm-dd" },
	...
	function fnExportTo() {
		...
		if(rowCount >= 100000) {
			...
			AUIGrid.exportToCsv(myGridID, {
				fileName : "통신사실 확인자료제공 요청 집행사실 통지유예 승인신청부_CSV"
			});
		}else{
			AUIGrid.exportToXlsx(myGridID, {
				fileName : "통신사실 확인자료제공 요청 집행사실 통지유예 승인신청부_EXCEL"
			});
		}
	};
