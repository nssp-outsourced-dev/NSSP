...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/stats/vrrListAjax/", "frmList", "#grid_list", 1);
	}
	...
	function initGrid() {
		var columnLayout = [
			...
			{ dataField : "REQST_DE", headerText : "요청일자", width : 120, cellMerge : true, mergePolicy:"restrict", dataType : "date", formatString : "yyyy-mm-dd"},
			{ dataField : "CHARGER_NM", headerText : "요청자", width : 120, cellMerge : true, mergePolicy:"restrict", mergeRef: "REQST_DE" },
			{ headerText : "통신사실 확인자료",
				children: [
					{ dataField : "TRGTER_NM", headerText : "대상자", width : 120 },
					{ dataField : "DTA_SCOPE", headerText : "제공받은 자료의 범위", width : 120 },
					{ dataField : "PRMISN_RECPT_DE", headerText : "회신일자", width : 120, dataType : "date", formatString : "yyyy-mm-dd" },
				]
			},
	...
	function fnExportTo() {
		...
		if(rowCount >= 100000) {
			...
			AUIGrid.exportToCsv(myGridID, {
				fileName : "통신사실 확인자료 회신대장_CSV"
			});
		}else{
			AUIGrid.exportToXlsx(myGridID, {
				fileName : "통신사실 확인자료 회신대장_EXCEL"
			});
		}
	};
