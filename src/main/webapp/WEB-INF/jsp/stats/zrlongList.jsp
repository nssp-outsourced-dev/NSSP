	...
	function initGrid() {
		...
		*/
		var columnLayout = [
			...
			{ headerText : "구속영장신청",
				children: [
					{ dataField : "", headerText : "신청부번호", width : 120, dataType : "date", formatString : "yyyy-mm-dd"},
					{ dataField : "", headerText : "발부연월일"},
				]
			},
			{ headerText : "석방",
				children: [
					{ dataField : "grdRslDt", headerText : "연월일", width : 120, dataType : "date", formatString : "yyyy-mm-dd"},
