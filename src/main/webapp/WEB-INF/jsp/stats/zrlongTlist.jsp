...
<script type="text/javascript">
	...
	function fnSearch() {
		fnMoveGridPage("/invsts/zrlongTlistAjax/", "frmList", "#grid_list", 1);
	}
	...
	function initGrid() {
		var columnLayout = [
			...
			{ dataField : "grdZrlongSeNm", headerText : "구분", width : 120},
			{ dataField : "grdTrgterNm", headerText : "피의자", width : 100},
			{ dataField : "grdVioltRootNm", headerText : "죄명", style:'tbLft' },
			{ dataField : "grdReqstDe", headerText : "신청일자", width : 120, dataType : "date", formatString : "yyyy-mm-dd"},
			/*{ dataField : "", headerText : "관서" }*/
			{ dataField : "grdValidDt", headerText : "영장유효기간", width : 120},
			{ dataField : "grdExcutDt", headerText : "처리집행", width : 120},
			{ dataField : "grdExcutIncpcty", headerText : "처리집행불능", width : 120}
			/* { dataField : "", headerText : "처리봔환<br/>일자", width : 120}, */
	...
	function fnExportTo() {
		...
		if(rowCount >= 100000) {
			...
			AUIGrid.exportToCsv(myGridID, {
				fileName : "체포구속영장원부_CSV"
			});
		}else{
			AUIGrid.exportToXlsx(myGridID, {
				fileName : "체포구속영장원부_EXCEL"
			});
		}
	};
