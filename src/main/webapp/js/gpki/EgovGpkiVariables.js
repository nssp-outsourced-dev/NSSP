...
// GPKIInstaller 사용시
var ServerAddr					= "127.0.0.1:80"//"192.168.200.23:9004";	// JEUS
//var ServerAddr 				= "192.168.200.23:8031";	// JBOSS
//var ServerAddr	 			= "192.168.200.23:8032";	// WEBLOGIC
var ConfigFilePath 				= "/html/gpki/setup/setup.conf";

// [설치 파일 경로 변수(html내부에서 사용됨)]
var SetupOffLineFilePath    = "/html/gpki/setup/GPKISecureWebSetup.exe";

// [설치완료후 이동할 페이지 설정]
var ServiceStartPageURL		= "/member/login/";
...
var CodeBase_GPKIInstaller	= " CODEBASE='http://localhost:80/html/gpki/setup/GPKIInstaller.cab#version=1,0,0,1'";
