...
GPKISecureWebUi.actionLogin = function(strData){
	...
	var strAcn = "";
	if(params[2].indexOf("actionGPKIreg") != -1) strAcn = "/member/actionGPKIreg/";
	else if (params[2].indexOf("actionGPKIjoinDN") != -1) strAcn = "/member/actionGPKIjoinDN/";
